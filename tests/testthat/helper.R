...
styled_example <- function() {
  ...
  plot_example() +
    ggplot2::theme(
      ...
      # Strip background (#This sets the panel background for facet-wrapped
      # plots to white, removing the standard grey ggplot background colour and
      # sets the title size of the facet-wrap title to font size 22)
